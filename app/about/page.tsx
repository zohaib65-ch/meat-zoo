...
export const metadata: Metadata = {
  title: "About",
  description:
    "Learn about Meat Zoo and our commitment to fresh, premium chicken delivery.",
};
      ...
      <div className="mx-auto grid w-full max-w-7xl gap-10 px-6 py-16 sm:px-8 lg:grid-cols-2 lg:items-center lg:px-10">
        <div>
          ...
          <h1 className="mt-4 font-display text-4xl font-semibold text-brand-dark sm:text-5xl">
            Trusted Fresh Chicken, Every Day
          </h1>
          <p className="mt-6 text-base leading-8 text-brand-muted">
            Meat Zoo was built to make quality poultry shopping simple, clean,
            and fast. We source carefully, process hygienically, and deliver
            fresh products designed for everyday family meals and premium home
            cooking.
          </p>
          <p className="mt-4 text-base leading-8 text-brand-muted">
            Our focus is clear: better cuts, better service, and a direct
            ordering experience through WhatsApp so customers can get what they
